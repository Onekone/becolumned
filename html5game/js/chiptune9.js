...
ChiptuneJsPlayer.prototype.getNumberOfSongs = function() {
  return libopenmpt._openmpt_module_get_num_subsongs(this.currentPlayingNode.modulePtr);  
}

ChiptuneJsPlayer.prototype.seek = function(order, row) {
  return libopenmpt._openmpt_module_set_position_order_row(this.currentPlayingNode.modulePtr,order,row);  
}
